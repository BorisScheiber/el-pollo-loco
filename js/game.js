...
function updateSoundIcon() {
  let soundOffPath = "img/icons/SoundOff.svg";
  let soundOnPath = "img/icons/SoundOn.svg";
...
function showGameOverScreenHtml() {
  return /*html*/ `
   <img class="end-screen-img" src="./img/9_intro_outro_screens/game_over/gameOverBg.png" alt="">
